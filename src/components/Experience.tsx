...
const Experience = () => {
  const experiences = [
    {
      ...
      technologies: ["HTML/CSS", "SQl", "React", "Java", "JavaScript", "NodeJS", "JDBC", "Hibernate", "Git", "Tailwind CSS"]
    },
    {
      type: "Internship",
      ...
      technologies: ["React", "Java", "JavaScript", "Git"]
    },
    {
      type: "Internship",
      title: "Intern",
  ...
  const education = {
    ...
    institution: "AJ Institute of Engineering and Technology, Manglore",
    duration: "2021 - 2025",
